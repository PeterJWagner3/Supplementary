...
#axis_label_pts=NULL
specified_axis_w_labels <- function(axe,max_val,min_val,maj_break,med_break,min_break,axis_labels,linewd=4/3,label_pos=c("tick","mid"),text_angle=NULL,text_pos=NULL,font_size=1,orient=1,print_label=TRUE,font="")	{
#axis(axe,at=seq(min_val,max_val,by=max_val-min_val),tcl=-0.0,labels = FALSE,lwd=linewd,las=orient)
