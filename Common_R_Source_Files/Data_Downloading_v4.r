...
bad_pbdb_collections <- c(1583,2237,3832,10285,49496,98219,154013,160725,226273);
hell_no <- F;
...
sedimentary_rocks <- c("arenarie","areniscas","argillaceous","argile","argiles","argillite","argilliti","ashes","ash","bentonite","bentonitic","calcaerous","calcaire","calcaires","calcare","calcarenite","calcarenites","calcirudites","calcirudite","carbonate","chalk","cherty","cherts","chert","clay","claystone","claystones","conglomerates","conglomerate","coquina","coquinas","diatomite","dolomites","dolomite","dolostones","dolostone","escudo","evaporites","evaporite","falun","flags","flagstone","flagstones","glauconites","glauconite","glauconitics","glauconitic","greensand","gres","grauwacke","greywacke","greywackes","grits","grit","kalk","kalkmergel","limestone","limestones","limeston","limstone","ls.","ls","lst","lst.","lutitas","marlstones","marlstone","marl","marls","marly","marne","marnes","micrites","micrite","mergel","mudstones","mudstone","ooid","ooids","oolites","oolite","oolitic","plattenkalk","pebbles","pebble","phosphatics","phosphatic","phosphorite","phosphorites","platenkalk","platy","qzt.","quartzite","quartzites","quarziti","radiolarite","radiolarites","reef","sables","sable","sands","sand","sandstone","sandstones","scheiferen","scheifer","schichten","schistes","shales","shale","shaly","silt","silts","siltstones","siltstone","slates","slate","tillite","tillites","tuff","tuffs","volcanic","volcanics");
